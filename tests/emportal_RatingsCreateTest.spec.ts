...
import {
  ...
  timesheetData,
  ratingData,
  capabilityRatingData,
  creativityRatingData,
...
test("Emportal Login test", async ({ page }) => {
  ...
  // Navigate to Manage Ratings & Verify the Manage Ratings page is visible
  await ratingsPage.navigateToRatings();

  // Add rating details
  // Click the Add Ratings button
  await ratingsPage.clickAssociateName(ratingData.associateId);

  // Fill in Capability rating details
  await ratingsPage.fillCapabilityTaskDetails(
    capabilityRatingData.executionEfficiencyDescription,
    "0.5",
  ...
  // Fill in Creativity rating details
  await ratingsPage.fillCreativityTaskDetails(
    creativityRatingData.originalityDescription,
    "0.5",
  ...
  // Fill in Collaboration rating details
  await ratingsPage.fillCollaborationTaskDetails(
    collaborationRatingData.teamContributionDescription,
    "0.5",
  ...
  // Fill in Compliance rating details
  await ratingsPage.fillComplianceTaskDetails(
    complianceRatingData.awarenessDescription,
    "0.5",
  ...
  // Fill in Customer rating details
  await ratingsPage.fillCustomerTaskDetails(
    customerRatingData.convenienceDescription,
    "0.5",
    customerRatingData.valueCreationDescription,
    "0.5",
